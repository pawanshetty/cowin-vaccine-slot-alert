...
export var getDefaultRoleAssumer = function (stsOptions, stsClientCtor) {
    ...
    return function (sourceCreds, params) { return __awaiter(void 0, void 0, void 0, function () {
        var logger, region, Credentials;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!stsClient) {
                        logger = stsOptions.logger, region = stsOptions.region;
 ...
 * @internal
 */
export var decorateDefaultCredentialProvider = function (provider) { return function (input) {
